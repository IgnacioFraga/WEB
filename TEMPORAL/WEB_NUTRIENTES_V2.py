...
for idato in range (df_pelacus_estado.shape[0]):
    ...
    # if str(df_pelacus_estado['Fecha_control_calidad_secundario'][idato]) == 'NaT':
    #     df_pelacus_estado['id_estado'][idato] = 0 
    # else:
    #     vector_tiempos = [df_pelacus_estado["Fecha_finalizacion_campana"][idato],df_pelacus_estado["Fecha_analisis"][idato],df_pelacus_estado["Fecha_procesado_laboratorio"][idato],df_pelacus_estado["Fecha_control_calidad_secundario"][idato]]
    #     (t_max,i_max) = max((v,i) for i,v in enumerate(vector_tiempos))
    #     df_pelacus_estado['id_estado'][idato] = i_max + 1  



# for idato in range (df_pelacus_estado.shape[0]):
#     if str(df_pelacus_estado['Fecha_control_calidad_secundario'][idato]) != 'NaT' and tiempo_consulta >= df_pelacus_estado['Fecha_control_calidad_secundario'][idato]:
#         df_pelacus_estado['id_estado'][idato] = 4  

#     if str(df_pelacus_estado['Fecha_control_calidad_secundario'][idato]) == 'NaT' and str(df_pelacus_estado['Fecha_procesado_laboratorio'][idato]) != 'NaT' and tiempo_consulta >= df_pelacus_estado['Fecha_procesado_laboratorio'][idato] :
#         df_pelacus_estado['id_estado'][idato] = 3 
        
#     if str(df_pelacus_estado['Fecha_control_calidad_secundario'][idato]) == 'NaT' and str(df_pelacus_estado['Fecha_procesado_laboratorio'][idato]) == 'NaT' and str(df_pelacus_estado['Fecha_analisis'][idato]) != 'NaT' and  tiempo_consulta >= df_pelacus_estado['Fecha_analisis'][idato] :
#         df_pelacus_estado['id_estado'][idato] = 2 
        
#     if str(df_pelacus_estado['Fecha_control_calidad_secundario'][idato]) == 'NaT' and str(df_pelacus_estado['Fecha_procesado_laboratorio'][idato]) == 'NaT' and str(df_pelacus_estado['Fecha_analisis'][idato]) == 'NaT' and  str(df_pelacus_estado['Fecha_finalizacion_campana'][idato]) != 'NaT' :
#         df_pelacus_estado['id_estado'][idato] = 1 
